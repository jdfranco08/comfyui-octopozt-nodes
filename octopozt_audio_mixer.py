        ...
        return {
            "required": {
                ...
                "voice_db":        ("FLOAT", {"default":   0.0, "min": -40.0, "max": 12.0, "step": 0.5,
                                              "display": "slider", "forceInput": True,
                                              "tooltip": "Volumen de la voz en dB — conectar desde Analyzer"}),
                "music_db":        ("FLOAT", {"default": -10.0, "min": -40.0, "max": 12.0, "step": 0.5,
                                              "display": "slider", "forceInput": True,
                                              "tooltip": "Volumen base de la música en dB — conectar desde Analyzer"}),
                "duck_db":         ("FLOAT", {"default":  -8.0, "min": -60.0, "max":  0.0, "step": 0.5,
                                              "display": "slider", "forceInput": True,
                                              "tooltip": "Nivel de ducking — conectar desde Analyzer"}),
